        ...
        def scraping(i):
                    try:
                        ...
                        with open('scrap2.html') as f:
                            ...
                            if "Extra Lecture" in tds[1].get_text() or "Lecture Scheduled" in tds[1].get_text():
                        ...
                        print(e)
        ele=["Basic Psychology","Foundations of Ethics","Understanding Cinema","Appreciating Cinema","Music in Media","Introduction to Theatre","Basic Sociology","Creative Writing"]
        ...
        for i in l:
            try:
                if l[j][2]==l[j+1][1] and l[j][0]==l[j+1][0]:
                    data.append([str(l[j][0]),str(l[j][1]),str(l[j+1][2]),str(l[j][3])])
                    j+=2
                else:
